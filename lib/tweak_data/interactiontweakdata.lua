...
function InteractionTweakData:init(tweak_data)
	...
	self.hold_choose_handedness = {
		text_id = "hud_int_hold_choose_handedness",
		action_text_id = "hud_int_hold_action_choose_handedness",
		timer = 1,
		interact_distance = 30,
		sound_done = "pick_up_poster"
	}
	self.press_choose_loadout_rifle_american = {
		text_id = "hud_int_press_choose_loadout_rifle_american",
		interact_distance = 100,
		loadout = "rifle_american",
		only_weapon_hand = true
	}
	self.press_choose_loadout_rifle_russian = {
		text_id = "hud_int_press_choose_loadout_rifle_russian",
		interact_distance = 100,
		loadout = "rifle_russian",
		only_weapon_hand = true
	}
	self.press_choose_loadout_sniper = {
		text_id = "hud_int_press_choose_loadout_sniper",
		interact_distance = 100,
		loadout = "sniper",
		only_weapon_hand = true
	}
	self.press_choose_loadout_shotgun = {
		text_id = "hud_int_press_choose_loadout_shotgun",
		interact_distance = 100,
		loadout = "shotgun",
		only_weapon_hand = true
	}
