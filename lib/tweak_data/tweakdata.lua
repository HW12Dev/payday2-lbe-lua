...
require("lib/tweak_data/VRArcadeTweakData")
...
function TweakData:_set_easy()
	...
	self.vr_arcade:set_difficulty(self, "easy")
end
...
function TweakData:_set_normal()
	...
	self.vr_arcade:set_difficulty(self, "normal")
end
...
function TweakData:_set_hard()
	...
	self.vr_arcade:set_difficulty(self, "hard")
end
...
function TweakData:_set_overkill()
	...
	self.vr_arcade:set_difficulty(self, "overkill")
end
...
function TweakData:_set_overkill_145()
	...
	self.vr_arcade:set_difficulty(self, "overkill_145")
end
...
function TweakData:_set_easy_wish()
	...
	self.vr_arcade:set_difficulty(self, "easy_wish")
end
...
function TweakData:_set_overkill_290()
	...
	self.vr_arcade:set_difficulty(self, "overkill_290")
end
...
function TweakData:_set_sm_wish()
	...
	self.vr_arcade:set_difficulty(self, "sm_wish")
end
...
Play the full version soon to get your full PAYDAY!]],
	...
	self.vr_arcade = VRArcadeTweakData:new(self)
