...
function VRArcadeTweakData:init(tweak_data)
		...
		rifle_russian = {
			...
			loadout = {
				...
				primaries = {
					...
					weapon_id = "akm",
					texture_switches = {
						wpn_fps_upg_o_specter = "1 5",
						wpn_fps_upg_o_45rds = "1 4"
					},
					blueprint = {
	...
	self.regen_limit = 0.3
	self.regen_amount = 0.33
	self.regen_time = 10
