...
function TeamAIMovement:add_weapons()
	if Network:is_server() then
		...
		elseif loadout.primary then
			self._unit:inventory():add_unit_by_factory_name(loadout.primary, false, false, managers.weapon_factory:blueprint_to_string(loadout.primary, loadout.blueprint), "")
		else
