...
function PlayerInventory:set_mask_visibility(state)
	...
	if state and (self._unit:movement():current_state_name() == "lobby_empty" or self._unit:movement():current_state_name() == "lobby_weapon" or self._unit:movement():current_state_name() == "lobby") then
		return
	end
