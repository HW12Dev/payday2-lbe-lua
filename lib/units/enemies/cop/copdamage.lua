...
function CopDamage:init(unit)
	...
	self._body_armor_impact_effect = {
...
function CopDamage:damage_bullet(attack_data)
	...
	if self._has_plate and attack_data.col_ray.body and attack_data.col_ray.body:name() == self._ids_plate_name and not attack_data.armor_piercing then
		...
		if armor_pierce_roll >= armor_pierce_value then
			if tweak_data.vr_arcade.extra_body_armor_sparks then
				self._body_armor_impact_effect.position = attack_data.col_ray.hit_position
				self._body_armor_impact_effect.normal = attack_data.col_ray.normal

				World:effect_manager():spawn(self._body_armor_impact_effect)
			end
