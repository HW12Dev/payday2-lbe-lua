...
SavefileManager.SETTING_SLOT = 10
SavefileManager.AUTO_SAVE_SLOT = 11
SavefileManager.PROGRESS_SLOT = 95
SavefileManager.BACKUP_SLOT = 95
...
function SavefileManager:load_settings()
	local cache = managers.user:get_setting_map()

	self:_set_cache(self.SETTING_SLOT, cache)
	self:_load(self.SETTING_SLOT, true)
end
