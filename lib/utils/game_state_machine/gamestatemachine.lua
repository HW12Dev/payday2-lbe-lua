...
function GameStateMachine:init()
	...
	local ingame_waiting_for_spawn_allowed = IngameWaitingForSpawnAllowed:new(self)
	...
	local ingame_host = IngameHost:new(self)
	...
	local ingame_host_func = callback(nil, ingame_host, "default_transition")
	...
	self:add_transition(ingame_waiting_for_players, ingame_waiting_for_spawn_allowed, ingame_waiting_for_players_func)
	self:add_transition(ingame_waiting_for_players, ingame_host, ingame_waiting_for_players_func)
	...
	self:add_transition(ingame_waiting_for_spawn_allowed, ingame_standard, ingame_waiting_for_spawn_allowed_func)
	self:add_transition(ingame_waiting_for_spawn_allowed, ingame_mask_off, ingame_waiting_for_spawn_allowed_func)
	self:add_transition(ingame_waiting_for_spawn_allowed, editor, ingame_waiting_for_spawn_allowed_func)
	self:add_transition(ingame_waiting_for_spawn_allowed, ingame_clean, ingame_waiting_for_spawn_allowed_func)
	self:add_transition(ingame_waiting_for_spawn_allowed, ingame_civilian, ingame_waiting_for_spawn_allowed_func)
	self:add_transition(ingame_waiting_for_spawn_allowed, gameoverscreen, ingame_waiting_for_spawn_allowed_func)
	self:add_transition(ingame_waiting_for_spawn_allowed, victoryscreen, ingame_waiting_for_spawn_allowed_func)
	self:add_transition(ingame_waiting_for_spawn_allowed, server_left, ingame_waiting_for_spawn_allowed_func)
	self:add_transition(ingame_waiting_for_spawn_allowed, disconnected, ingame_waiting_for_spawn_allowed_func)
	self:add_transition(ingame_waiting_for_spawn_allowed, kicked, ingame_waiting_for_spawn_allowed_func)
	self:add_transition(ingame_waiting_for_spawn_allowed, ingame_waiting_for_players, ingame_waiting_for_spawn_allowed_func)
	...
	self:add_transition(empty, ingame_waiting_for_spawn_allowed, empty_func)
